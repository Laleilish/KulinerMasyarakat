<section class="text-center px-5 pt-6 pb-4 md:px-10 md:py-[30px]">
    ...
    <div class="flex justify-center gap-4 mb-4 md:hidden">
        ...
        <div class="group flex flex-col items-center gap-2 cursor-pointer"
            ...
            <span class="text-[10px] font-semibold text-dark text-center">Tanggal Tua</span>
        </div>
        ...
        <div class="group flex flex-col items-center gap-2 cursor-pointer"
            ...
            <span class="text-[10px] font-semibold text-dark text-center">Usulkan Tempat</span>
        </div>
    ...
    <div class="flex justify-center gap-4 md:hidden">
        ...
        <div class="group flex flex-col items-center gap-2 cursor-pointer"
            ...
            <span class="text-[10px] font-semibold text-dark text-center">Split Bill</span>
        </div>
        ...
        <div class="group flex flex-col items-center gap-2 cursor-pointer"
            ...
            <span class="text-[10px] font-semibold text-dark text-center">Terserah</span>
        </div>
