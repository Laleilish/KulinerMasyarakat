...
@section('title', 'Verifikasi OTP - ' . config('app.name', 'KUMAR'))
        ...
        <div class="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-sm text-dark mb-2">Kode OTP untuk mereset kata sandi telah dikirimkan ke email Anda</p>
                ...
                <form method="POST" action="{{ route('password.otp.submit') }}" class="space-y-6">
                    ...
                    <div class="text-center">
                        <a href="{{ route('password.request') }}" class="text-sm text-dark hover:text-secondary flex items-center justify-center gap-1">
                ...
                <!-- Resend OTP -->
                <form id="resendForm" method="POST" action="{{ route('password.otp.resend') }}" style="display: none;">
                    @csrf
                </form>
            </div>
        </div>
