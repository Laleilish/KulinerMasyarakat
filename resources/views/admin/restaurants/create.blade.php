                ...
                <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <input type="url" name="gmaps_link" id="gmaps_link" value="{{ old('gmaps_link') }}" required maxlength="2048"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#B87A29]/20 focus:border-[#B87A29] transition-colors">
                        </div>
...
<script>
function createForm() {
    const initOpenHours = @js(old('open_hours', ''));
    let openTime = '';
    let closeTime = '';
    ...
    const initPriceRange = @js(old('price_range', ''));
    let priceMin = '';
    let priceMax = '';
