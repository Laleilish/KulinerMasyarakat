<section class="pt-5 pb-2" id="kampus-section">
    ...
    <div id="kampus-grid"
         class="grid grid-cols-3 md:grid-cols-5 gap-x-3 gap-y-4
        ...
        <div class="kampus-item flex flex-col items-center gap-2 cursor-pointer group"
             ...
             data-lng="{{ $campus->longitude }}"
             data-zoom="{{ $campus->map_zoom }}"
            ...
            <span class="kampus-label text-center text-[10px] leading-[1.35]
                         text-muted font-medium transition-all duration-200">
                {{ $campus->name }}
            </span>
        </div>
        @endforeach
