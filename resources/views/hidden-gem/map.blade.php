<section id="map-section" class="px-4 md:px-8 lg:px-0 pt-3 pb-6
                                  max-w-[720px] mx-auto scroll-mt-4">
    <h2 class="text-[19px] font-extrabold text-dark text-center mb-1">Peta Kampus</h2>
    <p class="text-center text-[12px] font-semibold text-[#F5A623] mb-4">
