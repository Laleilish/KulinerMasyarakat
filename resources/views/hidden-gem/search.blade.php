<section class="px-4 pt-4 pb-2 max-w-[600px] mx-auto" id="search-section">
    <div id="location-bar-wrap"
         class="relative bg-white rounded-2xl shadow-[var(--shadow-card)]
        ...
        <div class="flex items-center gap-3 px-4 h-[54px]">
            ...
            <div id="loc-icon-wrap" class="flex-shrink-0 w-5 flex items-center justify-center">
                <div id="loc-spinner"
                     class="hidden w-4 h-4 rounded-full border-2 border-[#F5A623]
            ...
            <div class="flex-1 flex flex-col justify-center min-w-0">
                <label id="loc-label"
                       class="text-[9px] text-muted font-semibold uppercase
            ...
            {{-- Tombol clear --}}
            <button id="loc-clear"
                    class="hidden flex-shrink-0 w-7 h-7 rounded-full
        ...
        <div id="loc-dropdown"
             class="hidden absolute top-[calc(100%+6px)] left-0 right-0
            ...
            {{-- Empty state --}}
            <div id="dropdown-empty"
                 class="hidden px-4 py-4 text-center">
