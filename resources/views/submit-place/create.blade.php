    ...
    <div class="min-h-screen bg-[#FDF8F0] py-12 flex items-center justify-center">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col md:flex-row gap-8 items-center">
            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center items-start md:pr-10">
                ...
                {{-- Success Message --}}
                @if (session('success'))
                    <div class="mt-6 w-full max-w-md bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl text-sm font-medium">
                        {{ session('success') }}
                    </div>
                @endif
            </div>
            ...
            <div class="w-full md:w-1/2 flex justify-center mt-8 md:mt-0">
                <div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] w-full max-w-md p-6 md:p-8" 
                     x-data="{ step: 1, rating: {{ old('initial_rating', 0) }}, photoName: '', landmarkName: '', reviewPhotoName: '' }">
                    ...
                    <form action="{{ route('submit-places.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div x-show="step === 1" x-transition.opacity.duration.300ms class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 text-gray-700" placeholder="Padang Banjir">
                                @error('name')
                            ...
                            <div>
                                ...
                                <label for="file-upload" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-emerald-400 border-dashed rounded-2xl bg-white hover:bg-emerald-50 transition-colors cursor-pointer group">
                                    <div class="space-y-2 text-center flex flex-col items-center">
                                        ...
                                        <p x-show="!photoName" class="text-sm text-emerald-600 font-bold">Seret foto ke sini atau klik</p>
                                        <p x-show="photoName" x-text="photoName" class="text-sm text-emerald-700 font-semibold truncate max-w-[200px]"></p>
                                        <input id="file-upload" name="photo" type="file" accept="image/jpg,image/jpeg,image/png" class="sr-only" @change="photoName = $event.target.files[0]?.name || ''">
                                        ...
                                        <div class="mt-2">
                                            <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-bold text-emerald-600 border border-emerald-500">
                                                <span x-text="photoName ? '✓ File dipilih' : 'Pilih File'"></span>
                                            </span>
                                        </div>
                                    </div>
                                </label>
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="3" class="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 text-gray-700 resize-none" placeholder="Restoran cukup kecil....">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div x-show="step === 2" x-transition.opacity.duration.300ms class="space-y-4" style="display: none;">
                            <div>
                                ...
                                <input type="text" name="address" value="{{ old('address') }}" class="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 text-gray-700" placeholder="Jl Padang Banjir">
                                @error('address')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="url" name="gmaps_link" value="{{ old('gmaps_link') }}" class="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 text-gray-700" placeholder="https://maps.app.goo.gl/...">
                                @error('gmaps_link')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="landmark" value="{{ old('landmark') }}" class="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 text-gray-700" placeholder="Depan indomaret...">
                                @error('landmark')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <label for="landmark-upload" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-emerald-400 border-dashed rounded-2xl bg-white hover:bg-emerald-50 transition-colors cursor-pointer group">
                                    <div class="space-y-2 text-center flex flex-col items-center">
                                        <svg class="h-8 w-8 text-emerald-500 group-hover:text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                                        </svg>
                                        <p x-show="!landmarkName" class="text-sm text-emerald-600 font-bold">Seret foto ke sini atau klik</p>
                                        <p x-show="landmarkName" x-text="landmarkName" class="text-sm text-emerald-700 font-semibold truncate max-w-[200px]"></p>
                                        <input id="landmark-upload" name="landmark_photo" type="file" accept="image/jpg,image/jpeg,image/png" class="sr-only" @change="landmarkName = $event.target.files[0]?.name || ''">
                                        <p class="text-xs text-gray-500 font-medium">Maks 5MB (JPG/PNG)</p>
                                        <div class="mt-2">
                                            <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-bold text-emerald-600 border border-emerald-500">
                                                <span x-text="landmarkName ? '✓ File dipilih' : 'Pilih File'"></span>
                                            </span>
                                        </div>
                                    </div>
                                </label>
                                @error('landmark_photo')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div x-show="step === 3" x-transition.opacity.duration.300ms class="space-y-4" style="display: none;">
                            <div>
                                ...
                                <input type="hidden" name="initial_rating" :value="rating">
                                <div class="flex justify-center gap-2">
                                    <template x-for="i in 5" :key="i">
                                        <svg @click="rating = i" 
                                             class="w-8 h-8 cursor-pointer transition-colors" 
                                             :class="i <= rating ? 'text-yellow-400' : 'text-gray-300 hover:text-yellow-300'"
                                             fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                        </svg>
                                    </template>
                                </div>
                                @error('initial_rating')
                            ...
                            <div>
                                ...
                                <textarea name="initial_review" rows="4" class="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 text-gray-700 resize-none" placeholder="Pelayanannya bagus, makanannya enak">{{ old('initial_review') }}</textarea>
                                @error('initial_review')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>

                            <div>
                                <span class="block text-sm font-bold text-gray-700 mb-1">Foto Tambahan</span>
                                <label for="extra-upload" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-emerald-400 border-dashed rounded-2xl bg-white hover:bg-emerald-50 transition-colors cursor-pointer group">
                                    <div class="space-y-2 text-center flex flex-col items-center">
                                        <svg class="h-8 w-8 text-emerald-500 group-hover:text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                                        </svg>
                                        <p x-show="!reviewPhotoName" class="text-sm text-emerald-600 font-bold">Seret foto ke sini atau klik</p>
                                        <p x-show="reviewPhotoName" x-text="reviewPhotoName" class="text-sm text-emerald-700 font-semibold truncate max-w-[200px]"></p>
                                        <input id="extra-upload" name="initial_review_photo" type="file" accept="image/jpg,image/jpeg,image/png" class="sr-only" @change="reviewPhotoName = $event.target.files[0]?.name || ''">
                                        <p class="text-xs text-gray-500 font-medium">Maks 5MB (JPG/PNG)</p>
                                        <div class="mt-2">
                                            <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-bold text-emerald-600 border border-emerald-500">
                                                <span x-text="reviewPhotoName ? '✓ File dipilih' : 'Pilih File'"></span>
                                            </span>
                                        </div>
                                    </div>
                                </label>
                                @error('initial_review_photo')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
